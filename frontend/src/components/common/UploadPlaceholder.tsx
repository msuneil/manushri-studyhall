...
export function UploadPlaceholder({ label, imageUrl, onUpload }: UploadPlaceholderProps) {
  ...
  return (
    <div className="w-full">
      ...
      >
        {imageUrl ? (
          <>
            <img src={imageUrl} alt={label} className="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity" />
            <div className="absolute inset-0 bg-slate-900/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
              <div className="flex flex-col items-center gap-2 text-white">
                ...
                <span className="text-xs font-bold tracking-wider uppercase">Change Logo</span>
              </div>
            </div>
          </>
        ) : (
          <>
            ...
            <div className="text-center">
              <p className="text-[10px] font-black uppercase tracking-wider text-slate-500">Tap to Upload</p>
              <p className="text-[10px] font-medium">Auto-Optimized Square Image</p>
            </div>
          </>
        )}
      </div>
