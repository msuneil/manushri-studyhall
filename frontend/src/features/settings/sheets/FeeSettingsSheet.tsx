...
import { FormSection, FormRow, FormInput, FormToggle, FormSelect } from '../../../components/common/FormAtoms';
...
export function FeeSettingsSheet({ isOpen, onClose, onSave }: FeeSettingsSheetProps) {
  ...
  const handleSave = async () => {
    ...
    updateSettings('paymentSettings', {
      ...
      lateFeeAmount: formData.lateFeeEnabled ? (parseInt(formData.lateFeeAmount, 10) || 0) : 0
    });
